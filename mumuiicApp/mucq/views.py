...
from mucq.models import Song, Watchlater, History, Channel
...
def history(request):
    if request.method == "POST":
        ...
        return redirect(f"/mucq/songs/{music_id}")
    ...
    return render(request, 'mucq/history.htm', {"history": song})
...
def watchlater(request):
    if request.method == "POST":
        ...
        return render(request, f"mucq/songpost.htm", {'song': song, "message": message})
    ...
    return render(request, "mucq/watchlater.htm", {'song': song})

def songs(request):
    song = Song.objects.all()
    return render(request, 'mucq/songs.htm', {'song': song})

def songpost(request, id):
    song = Song.objects.filter(song_id=id).first()
    return render(request, 'mucq/songpost.htm', {'song': song})
...
def login(request):
    ...
    return render(request, 'mucq/login.htm')
...
def signup(request):
    ...
    return render(request, 'mucq/signup.htm')
...
def channel(request, channel):
    ...
    return render(request, "mucq/channel.htm", {"channel": chan, "song": song})
...
def upload(request):
    ...
    return render(request, "mucq/upload.htm")
